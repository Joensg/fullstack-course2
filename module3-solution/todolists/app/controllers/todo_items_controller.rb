class TodoItemsController < ApplicationController
  ...
  def index
    ...
    @number_of_completed_todos = TodoItem.get_count_of_completed_todo_items
  end
  ...
  def create
    ...
    respond_to do |format|
      if @todo_item.save
        ...
        format.json { render :index, status: :created, location: todo_items_url }
      else
  ...
  private
    ...
    def todo_item_params
      params.require(:todo_item).permit(:title, :description, :completed, :due_date)
    end
end
